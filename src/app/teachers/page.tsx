      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[var(--color-bg)]/90 backdrop-blur-md border-b border-[var(--color-border)]">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-8 text-sm font-medium text-[var(--color-text-muted)]">
             <Link href="/teachers" className="text-[var(--color-accent)]">Giáo viên</Link>
          ...
          {isMenuOpen && (
            ...
            >
              <div className="px-6 py-4 space-y-4">
                <Link href="/teachers" className="block text-[var(--color-accent)] font-medium">Giáo viên</Link>
                <Link href="/#students" className="block text-[var(--color-text-muted)]">Học sinh</Link>
                <Link href="/#parents" className="block text-[var(--color-text-muted)]">Phụ huynh</Link>
      ...
      <footer className="py-16 px-6 border-t border-[var(--color-border)] bg-[var(--color-bg)]">
         <div className="max-w-6xl mx-auto grid md:grid-cols-12 gap-12">
            ...
            <div className="md:col-span-2 space-y-4">
               ...
               <ul className="space-y-2 text-sm text-[var(--color-text-muted)]">
                  <li><Link href="/teachers" className="hover:text-[var(--color-text)] transition-colors">Cho giáo viên</Link></li>
